...
export function evaluateBidButtonStatus(amIWinning) {
    ...
    if (currentStatus === 'idle') {
        ...
        let chip = soldPlayer + '  ·  ' + soldAmt + '  ·  ' + soldBidder;
        let rep  = chip + '   ❖   ';
        btn.className = 'action-btn-bid btn-bid-sold-marquee';
        btn.innerHTML = '<span class="bid-sold-marquee"><span class="bid-sold-track">' + rep + rep + rep + '</span></span>';
        btn.disabled  = true;
        bidZone.style.borderColor = 'rgba(40,167,69,.3)';
