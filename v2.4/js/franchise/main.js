...
function updateMyTeamUI() {
    try {
        ...
        Object.keys(state.allRegisteredTeams).forEach(t => {
            ...
            othersHtml += `
            <div class="other-team-card-hz${lgClass}" data-team="${esc(t)}" style="border-top-color:${tColor}; background: linear-gradient(to left, rgba(${r16},${g16},${b16},0.18) 0%, #0a0a0f 65%); border-color: rgba(${r16},${g16},${b16},0.3);">
                ${bgLogoDivHtml}
