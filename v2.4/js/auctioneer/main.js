...
function updateBudgetTracker() {
    ...
    for (let i = 0; i < totalSlots; i++) {
        if (i < keys.length) {
            ...
            let logoHtml = _tLogo ? `<img src="${esc(_tLogo)}" style="height:28px;max-width:52px;object-fit:contain;filter:drop-shadow(0 0 4px rgba(255,255,255,0.15));margin-bottom:3px;" alt="">` : '';
